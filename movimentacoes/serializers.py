...
class CriarMovimentacaoSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if movimentacao:  # Se está editando
            ...
            print(f"👤 Criado por: {movimentacao.created_by.nome_completo if movimentacao.created_by else 'Ninguém'} (ID: {movimentacao.created_by.id if movimentacao.created_by else 'N/A'})")
