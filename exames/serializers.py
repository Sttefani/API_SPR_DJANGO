...
class ExameSerializer(serializers.ModelSerializer):
    ...
    codigo = serializers.CharField(
        ...
        validators=[
            UniqueValidator(
                ...
                message="Já existe um exame com este código.",
            )
        ],
    )
    nome = serializers.CharField(
        ...
        validators=[
            UniqueValidator(
                queryset=Exame.objects.all(),
                message="Já existe um exame com este nome.",
            )
        ],
    )
    ...
    def get_is_parent(self, obj):
        """Retorna True se este exame possuir filhos (for um grupo)"""
        return Exame.objects.filter(parent=obj).exists()
